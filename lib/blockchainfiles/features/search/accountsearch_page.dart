...
class _AccountSearchPageState extends State<AccountSeachpage> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(backgroundColor: Colors.blue.shade300,title: const Text("Search Account Details",style: TextStyle(fontWeight: FontWeight.bold),),centerTitle: true,),
